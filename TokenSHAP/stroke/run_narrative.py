...
#
# Output:
#   Prints each story to console and appends all entries to stroke_log.json
# =============================================================================
...
for i, pkl_path in enumerate(pkl_files, start=1):
    ...
    story, narrative_prompt = storyteller.generate_story(
        ...
        task_description="predict whether a patient is at high or low risk for a stroke",
    ...
    logger.save(
        ...
        patient_profile=tokenshap_results.get("patient_profile"),

...
# CLI arguments
# ---------------------------------------------------------------------------
parser = argparse.ArgumentParser(description="Run TokenSHAP analysis for Stroke")
...
for i, idx in enumerate(indices, start=1):
    ...
    system_prompt, user_prompt = build_stroke_prompt(patient_profile=patient_profile)
